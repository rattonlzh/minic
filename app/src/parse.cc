// Generated by Bisonc++ V6.01.00 on Wed, 29 Apr 2020 23:37:13 +0800
...
try
{
    ...
    switch (production)
    {
        ...
        case 1:
        {
         d_val__ = TreeUtil::buildTree("程序", {vs__(0)});
        ...
        case 10:
        {
         TreeNode* tmp = TreeUtil::buildTree("参数", {vs__(-2)});
         d_val__ = TreeUtil::buildTree("函数声明", {vs__(-5), vs__(-4), tmp, vs__(0)});
         }
        break;
        ...
        case 17:
        {
         d_val__ = TreeUtil::buildTree("{}", {vs__(-2), vs__(-1)});
         }
        break;
        ...
        case 29:
        {
         d_val__ = TreeUtil::buildTree("if", {vs__(-2), vs__(0)});
         }
        break;

        case 30:
        {
         d_val__ = TreeUtil::buildTree("if", {vs__(-4), vs__(-2), vs__(0)});
         }
        break;

        case 31:
        {
         d_val__ = TreeUtil::buildTree("while", {vs__(-2), vs__(0)});
         }
        break;
        ...
        case 59:
        {
         d_val__ = TreeUtil::buildTree("参数", {vs__(0)});
         }
        break;
